...
-- 🎮 Functionality for ESP and Rerolling
local toggleESP = createButton("👁 Toggle Mutation ESP", 140, Color3.fromRGB(120, 255, 150))
local rerollMutation = createButton("🎲 Reroll Mutation", 190, Color3.fromRGB(90, 200, 255))
local rerollPetDisplay = createButton("♻️ Reroll Pet ESP", 240, Color3.fromRGB(80, 140, 255))

local credit = Instance.new("TextLabel", frame)
credit.Size = UDim2.new(1, 0, 0, 20)
credit.Position = UDim2.new(0, 0, 1, -22)
credit.Text = "💡 by Saikiontop"
