...
screenGui.Name = "PetToolsMasterGUI"

local loadButton = Instance.new("TextButton", screenGui)
loadButton.Size = UDim2.new(0, 240, 0, 40)
loadButton.Position = UDim2.new(0, 20, 0, 50)
loadButton.BackgroundColor3 = Color3.fromRGB(80, 80, 200)
